 ...
 *
 * MERVE 2026-09-24: az akvarium-DTO ket mezoje (`CreateAquariumDto.
 * systemVolumeIsManual`, `CreateAquariumEquipmentDto.quantity = 1`) ezen a
 * hianyon bukott -- a mobil oldal helyesen kuldte oket, a DTO is ismerte,
 * csak EZ A KIOLVASAS nem latta. Mindket helyen eseti tipusjelolessel
 * (`: boolean`, `: number`) lett feloldva a #1052/#1054 koron, ez a
 * javitas magat a KIOLVASAST teszi altalanosabba, hogy a kovetkezo hasonlo
 * mezonel ne kelljen ujra eseti foltot tenni ra. Ha csak a `:`-os alakot
 * neznenk, a jegy DTO-janak a fele is kimaradna -- ugyanez a hianyossag
