...
/// double compiles while missing a method the writer calls, or returning
/// less than it promises, and fails only at run time.
export interface PosSaleTransaction extends InventoryMovementDatabase {
  salesOrder: {
