...
const SERVER_PAIR: Record<string, string | null> = {
  ...
  // AKVÁRIUM, SAJÁT JOGPÁRRAL (2026-09-24) -- nem a fenti `service.*` pár,
  // ezért a mobil oldalon is külön `canView`/`canManage` számítja, nem a
  // szerviz hármas közös változója.
