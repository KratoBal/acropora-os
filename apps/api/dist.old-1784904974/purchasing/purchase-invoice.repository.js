...
import { purchaseInvoiceDetailInclude, purchaseInvoiceSummaryInclude, toPurchaseInvoiceDetail, toPurchaseInvoiceSummary, } from "./purchase-invoice.types.js";
export const PURCHASE_INVOICE_DATABASE = Symbol("PURCHASE_INVOICE_DATABASE");
let PurchaseInvoiceRepository = class PurchaseInvoiceRepository extends Repository {
    invoiceDatabase;
    constructor(invoiceDatabase) {
        super(prisma);
        this.invoiceDatabase =
            invoiceDatabase ?? prisma;
    }
    ...
    async create(params) {
        const now = new Date();
        const created = await this.invoiceDatabase.$transaction(async (transaction) => {
...
PurchaseInvoiceRepository = __decorate([
    Injectable(),
    __param(0, Optional()),
    __param(0, Inject(PURCHASE_INVOICE_DATABASE)),
    __metadata("design:paramtypes", [Object])
], PurchaseInvoiceRepository);
export { PurchaseInvoiceRepository };
//# sourceMappingURL=purchase-invoice.repository.js.map