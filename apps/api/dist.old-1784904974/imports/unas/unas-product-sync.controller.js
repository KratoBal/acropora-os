...
let UnasProductSyncController = class UnasProductSyncController {
    auth;
    sync;
    repository;
...
], UnasProductSyncController.prototype, "run", null);
__decorate([
    Get("sync-runs/:runId"),
...
], UnasProductSyncController.prototype, "getRun", null);
__decorate([
    Get("sync-runs"),
    RequirePermissions(PERMISSIONS.PRODUCTS_VIEW),
    __param(0, Query()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [UnasSyncRunsQueryDto]),
    __metadata("design:returntype", void 0)
], UnasProductSyncController.prototype, "listRuns", null);
UnasProductSyncController = __decorate([
...
export { UnasProductSyncController };
//# sourceMappingURL=unas-product-sync.controller.js.map