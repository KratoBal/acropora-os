...
/**
 * FIGMA 12. KÖR, 5. CSOPORT (aláírás, kiküldés aláírásra, bejegyzés) --
 ...
 * lásd a `figma12-group2-theme.spec.ts` és a többi csoport azonos
 * indoklását: hat független, egymásra nem épülő PR-csoport nem oszthat meg
 * egy be nem olvadt modult.
 *
 ...
 * és a `node:test` importot az `expo export` nem tudja feloldani -- ez a
 * "Static verification" CI-lépés bukott emiatt a korábbi csoportoknál is
 * (#1146, #1147, #1149, #1150).
 */
...
const KEPERNYOK = [
  { fajl: join("worksheets", "sign", "[id].tsx"), nev: "Munkalap aláírása" },
  {
    fajl: join("worksheets", "send-for-signature", "[id].tsx"),
    nev: "Kiküldés aláírásra",
  },
  { fajl: join("worksheets", "entries", "[id].tsx"), nev: "Bejegyzés" },
];

describe("Figma 12. kör, 5. csoport: nincs fix hex, useAppTheme mindenütt", () => {
